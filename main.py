    ...
    if response.status_code == requests.codes.ok:
        if response.json()["states"][place]["enabled"] is False or response.json()["states"][place]["enabled"] is True:
            if datetime.time(8, 30) > current_time.time():
                ...
                return f"Зараз перший урок: Українська мова/Англійська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(8, 30)).replace(microsecond=0)})"
            elif current_week == 0 and datetime.time(9, 25) <= current_time.time() <= datetime.time(10, 10):
                return f"Зараз другий урок: Українська мова/Англійська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(9, 25)).replace(microsecond=0)})"
            elif current_week == 0 and datetime.time(10, 30) <= current_time.time() <= datetime.time(11, 15):
                return f"Зараз третій урок: Англійська мова/Українська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(10, 30)).replace(microsecond=0)})"
            elif current_week == 0 and datetime.time(11, 35) <= current_time.time() <= datetime.time(12, 20):
                return f"Зараз четвертий урок: Англійська мова/Українська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(11, 35)).replace(microsecond=0)})"
                ...
                return f"Зараз четвертий урок: Німецька мова/Інформатика (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(11, 35)).replace(microsecond=0)})"
            elif current_week == 2 and datetime.time(12, 30) <= current_time.time() <= datetime.time(13, 15):
                return f"Зараз п'ятий урок: Німецька мова/Інформатика (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(12, 30)).replace(microsecond=0)})"
            elif current_week == 2 and datetime.time(13, 25) <= current_time.time() <= datetime.time(14, 10):
                return f"Зараз шостий урок: Інформатика/Німецька мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(13, 25)).replace(microsecond=0)})"
            elif current_week == 2 and datetime.time(14, 20) <= current_time.time() <= datetime.time(15, 5):
                return f"Зараз сьомий урок: Інформатика/Німецька мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(14, 20)).replace(microsecond=0)})"
                ...
                return f"Зараз п'ятий урок: Українська мова/Англійська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(12, 30)).replace(microsecond=0)})"
            elif current_week == 3 and datetime.time(13, 25) <= current_time.time() <= datetime.time(14, 10):
                return f"Зараз шостий урок: Українська мова/Англійська мова (Вона вже йде - {datetime.datetime.combine(datetime.date.today(), datetime.datetime.now().time()).replace(microsecond=0) - datetime.datetime.combine(datetime.date.today(), datetime.time(13, 25)).replace(microsecond=0)})"
